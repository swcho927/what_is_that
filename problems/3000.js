...
(function () {
    ...
    // N=300, 이미 정렬됨
    (function() {
        var arr = []; for (var i = 1; i <= 300; i++) arr.push(i);
        testCases.push(makeCase(arr));
    })();

    // N=300, 역순
    (function() {
        var arr = []; for (var i = 300; i >= 1; i--) arr.push(i);
        testCases.push(makeCase(arr));
    })();

    // N=300, 모두 같은 값
    (function() {
        var arr = []; for (var i = 0; i < 300; i++) arr.push(42);
        testCases.push(makeCase(arr));
    })();
    ...
    (function() {
        var arr = [];
        for (var i = 0; i < 150; i++) arr.push(1);
        for (var i = 0; i < 150; i++) arr.push(1000000);
        testCases.push(makeCase(arr));
    })();

    // N=300, 최솟값만
    (function() {
        var arr = []; for (var i = 0; i < 300; i++) arr.push(1);
        testCases.push(makeCase(arr));
    })();

    // N=300, 최댓값만
    (function() {
        var arr = []; for (var i = 0; i < 300; i++) arr.push(1000000);
        testCases.push(makeCase(arr));
    })();

    // N=300, 교대 패턴 (1, 1000000, 1, 1000000, ...)
    (function() {
        var arr = [];
        for (var i = 0; i < 300; i++) arr.push(i % 2 === 0 ? 1 : 1000000);
        testCases.push(makeCase(arr));
    })();
    ...
    (function() {
        var arr = [];
        for (var i = 0; i < 300; i++) arr.push(500000 + (i % 3) - 1);
        testCases.push(makeCase(arr));
    })();
    ...
    window.PROBLEMS['3000'] = {
        ...
        inputDesc:   "첫째 줄에 N이 주어진다. (1 ≤ N ≤ 300)<br>둘째 줄에 N개의 정수 Aᵢ가 공백으로 구분하여 주어진다. (1 ≤ Aᵢ ≤ 1,000,000)",
